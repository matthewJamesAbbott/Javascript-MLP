...
<body>
    ...
    <div class="section">
        <h2>Predict</h2>
        <label>Input (comma separated): <input type="text" id="predictInput" value="0.19,0.21,0.32,0.43,0.54,0.65,0.77,0.88,0.99,0.01"></label>
        <button onclick="predictInput()">Predict</button>
        <div id="predictOutput"></div>
    </div>

    <script>
        // Activation Functions (keeping your existing implementation)
        ...
        // Enhanced Evaluation Functions with Epoch Support
        class MLEvaluation {
        ...
        // Your existing MLP classes (keeping the same implementation)
        class TDataPoint {
